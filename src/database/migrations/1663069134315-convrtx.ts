...
export class convrtx1663069134315 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "gw_route_clue_medias" ("gwRouteCluesId" uuid NOT NULL, "gwFilesId" uuid NOT NULL, CONSTRAINT "PK_33d0c30fb3b73cf1bdcc15c7788" PRIMARY KEY ("gwRouteCluesId", "gwFilesId"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_d28460eb069063529fd5a3d991" ON "gw_route_clue_medias" ("gwRouteCluesId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_0818434dacf3bd3304dff131dd" ON "gw_route_clue_medias" ("gwFilesId") `,
    );
    await queryRunner.query(
      `CREATE TABLE "gw_route_historical_event_medias" ("gwRouteHistoricalEventsId" uuid NOT NULL, "gwFilesId" uuid NOT NULL, CONSTRAINT "PK_0734874036b1a7c28a11b305b96" PRIMARY KEY ("gwRouteHistoricalEventsId", "gwFilesId"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_bfc2a007b31e02ef713730689c" ON "gw_route_historical_event_medias" ("gwRouteHistoricalEventsId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_0c93cde35513355096a8089ee3" ON "gw_route_historical_event_medias" ("gwFilesId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "gw_routes" ADD CONSTRAINT "FK_1aa2cc463bccf7c876d9b9dd698" FOREIGN KEY ("user_id") REFERENCES "gw_users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "gw_routes" ADD CONSTRAINT "FK_992a163bcc405350252911e10a6" FOREIGN KEY ("picture_id") REFERENCES "gw_files"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "gw_route_historical_events" ADD CONSTRAINT "FK_cdf3e8385f5c969d73a72ae1515" FOREIGN KEY ("picture_id") REFERENCES "gw_files"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "gw_tickets" ADD CONSTRAINT "FK_690ba067016ac8a66f0182498dd" FOREIGN KEY ("statusId") REFERENCES "gw_statuses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "gw_treasure_chests" ADD CONSTRAINT "FK_539fdad8641f0e2504a34153eea" FOREIGN KEY ("picture_id") REFERENCES "gw_files"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "gw_route_clue_medias" ADD CONSTRAINT "FK_d28460eb069063529fd5a3d991c" FOREIGN KEY ("gwRouteCluesId") REFERENCES "gw_route_clues"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "gw_route_clue_medias" ADD CONSTRAINT "FK_0818434dacf3bd3304dff131dd7" FOREIGN KEY ("gwFilesId") REFERENCES "gw_files"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "gw_route_historical_event_medias" ADD CONSTRAINT "FK_bfc2a007b31e02ef713730689c6" FOREIGN KEY ("gwRouteHistoricalEventsId") REFERENCES "gw_route_historical_events"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "gw_route_historical_event_medias" ADD CONSTRAINT "FK_0c93cde35513355096a8089ee3a" FOREIGN KEY ("gwFilesId") REFERENCES "gw_files"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "gw_route_historical_event_medias" DROP CONSTRAINT "FK_0c93cde35513355096a8089ee3a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "gw_route_historical_event_medias" DROP CONSTRAINT "FK_bfc2a007b31e02ef713730689c6"`,
    );
    await queryRunner.query(
      `ALTER TABLE "gw_route_clue_medias" DROP CONSTRAINT "FK_0818434dacf3bd3304dff131dd7"`,
    );
    await queryRunner.query(
      `ALTER TABLE "gw_route_clue_medias" DROP CONSTRAINT "FK_d28460eb069063529fd5a3d991c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "gw_treasure_chests" DROP CONSTRAINT "FK_539fdad8641f0e2504a34153eea"`,
    );
    await queryRunner.query(
      `ALTER TABLE "gw_tickets" DROP CONSTRAINT "FK_690ba067016ac8a66f0182498dd"`,
    );
    await queryRunner.query(
      `ALTER TABLE "gw_route_historical_events" DROP CONSTRAINT "FK_cdf3e8385f5c969d73a72ae1515"`,
    );
    await queryRunner.query(
      `ALTER TABLE "gw_route_historical_events" DROP CONSTRAINT "FK_bf08ddd9f78d926908d12ebc7e5"`,
    );
    await queryRunner.query(
      `ALTER TABLE "gw_routes" DROP CONSTRAINT "FK_992a163bcc405350252911e10a6"`,
    );
    await queryRunner.query(
      `ALTER TABLE "gw_routes" DROP CONSTRAINT "FK_1aa2cc463bccf7c876d9b9dd698"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0c93cde35513355096a8089ee3"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_bfc2a007b31e02ef713730689c"`,
    );
    await queryRunner.query(`DROP TABLE "gw_route_historical_event_medias"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0818434dacf3bd3304dff131dd"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d28460eb069063529fd5a3d991"`,
    );
