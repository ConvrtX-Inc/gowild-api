...
export class convrtx1669467887940 implements MigrationInterface {
    name = 'convrtx1669467887940'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "gw_users" ADD CONSTRAINT "FK_2ee66bd428d223061fc17587d13" FOREIGN KEY ("role_id") REFERENCES "gw_roles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "gw_users" DROP CONSTRAINT "FK_2ee66bd428d223061fc17587d13"`);
