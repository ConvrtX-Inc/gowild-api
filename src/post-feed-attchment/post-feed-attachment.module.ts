...
import { PostFeedAttachmentService } from './post-feed-attachment.service';
import { PostFeedAttachment } from './post-feed-attachment.entity';

@Module({
  providers: [PostFeedAttachmentService],
  imports: [TypeOrmModule.forFeature([PostFeedAttachment]) , 
    ...
    useFactory: (configService: ConfigService) => {
      ...
      return {
        fileFilter: (request, file, callback) => {
          if (!file.originalname.match(/\.(jpg|jpeg|png|gif|txt|pdf|docs|docx)$/i)) {
            return callback(
...
export class PostFeedAttachmentModule {}
