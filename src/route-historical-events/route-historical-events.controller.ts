...
{
  constructor(
    readonly service: RouteHistoricalEventsService,
  ...
  public async create(
    ...
    @Body() dto: CreateRouteHistoricalEventDto,
  ) {
    return {
  ...
  public async updateHistoricalEvents(
    @Param('id') id: string,
    @Body() dto: UpdateRouteHistoricalEventDto,
  ) {
    return {
